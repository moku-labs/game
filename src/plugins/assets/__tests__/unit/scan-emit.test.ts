...
describe("emitKeys", () => {
  it("writes the header, both unions and the nine-slice table", () => {
    expect(emitKeys(manifest)).toBe(`// generated by @moku-labs/game/assets-scan, do not edit
...
`);
  ...
  it("writes never for an empty game", () => {
    expect(emitKeys(empty)).toBe(`// generated by @moku-labs/game/assets-scan, do not edit
