/**
 * @file Content of the fixture merge game as plain data: the board, one chain of three levels,
 * one generator with charges and a cooldown, two order slots and the energy rule.
 */
...
export const tables = {
  chains: { wood: { top: 3, sellPrice: [0, 2, 6] } },
  generators: {
    sawmill: {
      cell: "c0_0",
      energyCost: 1,
...
/** The two order slots a new player starts with. */
